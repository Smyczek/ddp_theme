@php 
  $legal_videography = get_field('legal_videography');
@endphp

<section class="pt-10">
  @if ($legal_videography && $legal_videography['title'])
    <x-section-title :title="$legal_videography['title']" :image-id="$legal_videography['title_icon']"/>
  @endif
</section>
